...
export default function CreateSociety() {
    ...
    const [formData, setFormData] = useState({
        ...
        chair_name: '',
        description: '',
        faculty_name: 'random', // Default value
    });
    ...
    return (
        <div className="max-w-3xl mx-auto">
            <div className="mb-8 flex items-center gap-4">
                ...
                <div>
                    <h2 className="text-3xl font-bold text-[#0A1A2F]">Create Society</h2>
                    <p className="text-[#64748B] text-sm mt-1">Add a new society to the portal</p>
                </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="relative group">
                        <textarea
                            ...
                            onChange={handleChange}
                            rows={4}
                            className="peer w-full bg-transparent border-b-2 border-[#D4E4F7] py-3 text-[#0A1A2F] outline-none transition-colors duration-300 focus:border-[#0B5ED7] placeholder-transparent resize-none"
                            placeholder=" "
                        />
                        <label
                            htmlFor="description"
                            className="absolute left-0 -top-3.5 text-xs font-medium text-[#0B5ED7] transition-all duration-300 peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-base peer-placeholder-shown:text-[#94A3B8] peer-placeholder-shown:font-normal peer-focus:-top-3.5 peer-focus:text-xs peer-focus:text-[#0B5ED7] peer-focus:font-medium"
                        >
                            Description
                        </label>
                    ...
                    <div className="pt-4 flex justify-end">
                        ...
                        >
                            <span className="relative z-10">{submitting ? 'Creating...' : 'Create Society'}</span>
